...
public class Tileset {
    ...
    public BufferedImage getFrame(int tile, int tileset, int tiled) {
        ...
        if (tileset == 0) {
            ...
            return mTerrainTile[tile]; //.getSubimage(0, tile3 * 16, 0, 0);
        } else if (tileset == 32) {
    ...
    private void initDefinitions() {
        ...
        String path = "";
        path = "res/obj/block/" + mTilesetIndex[0] + "/tileset.ini";
        String line = "";
        //tileset 1
        try {
        ...
        //tileset 2
        path = "res/obj/terrain/" + mTilesetIndex[1] + "/tileset.ini";
        try {
        	InputStream is = Main.class.getResourceAsStream(path); 
            BufferedReader input = new BufferedReader(new InputStreamReader(is));   
            try {
        ...
        //tileset 3
        path = "res/obj/scenery/" + mTilesetIndex[2] + "/tileset.ini";
        try {
        	InputStream is = Main.class.getResourceAsStream(path); 
            BufferedReader input = new BufferedReader(new InputStreamReader(is));   
            try {
