...
public class Turtle extends Sprite implements IEntity {
     ...
     */
    public Turtle(Main main, Object g, String path) throws NumberFormatException, IOException {
