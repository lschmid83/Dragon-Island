...
/**
 * SpinyBeetle.java
 * This class is a spiny beetle enemy.
...
public class SpinyBeetle extends Sprite implements IEntity {

    /** Main thread. */
    private Main mMain;
	
    /** 
     * Initialises a SpinyBeetle object. 
     ...
     */
    public SpinyBeetle(Main main, Object g, String path) throws NumberFormatException, IOException {
