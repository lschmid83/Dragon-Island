...
public class UserInterface {
    ...
    public UserInterface() {
        ...
        try 
        {
            BufferedReader input = new BufferedReader(new FileReader("res/gui/credits.txt"));
            String line = null;
            while ((line = input.readLine()) != null) {
                mCreditsText.add(line);
            }
            input.close();
    ...
    */
    ...
    public void draw(Graphics g) {
        ...
        } else if (Settings.State.equals("new") || Settings.State.equals("level editor load game")) 
        {
            ...
            int x = 239 - (mGameFont.getStringWidth(SaveFile.mGameName.get(SaveFile.mGameNumber)) / 2);
        ...
        } else if (Settings.State.equals("options")) //options
        {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if (i == 0) {
                    if (Settings.Music) {
                        mGameFont.drawString(g, sel, "Music On", 202, 130);
                    } else {
                        mGameFont.drawString(g, sel, "Music Off", 202, 130);
                    }

                } else if (i == 1) {
                    if (Settings.Sound) {
                        mGameFont.drawString(g, sel, "Sound On", 202, 150);
                    } else {
                        mGameFont.drawString(g, sel, "Sound Off", 202, 150);
                    }
                } else if (i == 2) {
                    mGameFont.drawString(g, sel, "Credits", 202, 170);
                } else if (i == 3) {
                    if (Settings.DebugMenu) {
                        mGameFont.drawString(g, sel, "Debug", 202, 190);
                    }
                }
            }
            g.drawImage(mTitleLogo, (480 / 2) - (mTitleLogo.getWidth() / 2), 20, null);
        } else if (Settings.State.equals("erase"))
        {
            ...
            mLevelHeader = Main.mFrame.mEditorPanel.getHeader();
            ...
            for (int i = 0; i < 26; i++) {
                ...
                if (i == 0) {
                    ...
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.world), 118, 50);
                } else if (i == 1) {
                    mGameFont.drawString(g, sel, "Level", 20, 70);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.level), 118, 70);
                } else if (i == 2) {
                    mGameFont.drawString(g, sel, "Area", 20, 90);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.area), 118, 90);
                } else if (i == 3) {
                    mGameFont.drawString(g, sel, "Bg Near", 20, 110);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.bg[0]), 118, 110);
                } else if (i == 4) {
                    mGameFont.drawString(g, sel, "Bg Middle", 20, 130);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.bg[1]), 118, 130);
                } else if (i == 5) {
                    mGameFont.drawString(g, sel, "Bg Far", 20, 150);
                    if (mLevelHeader.bg[2] == 0) {
                        mGameFont.drawString(g, sel, "RGB", 118, 150);
                    } else {
                        mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.bg[2]), 118, 150);
                    }
                } else if (i == 6) {
                    mGameFont.drawString(g, sel, "Bg Speed", 20, 170);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.bgSpeed[0]) + "?" + Integer.toString(mLevelHeader.bgSpeed[1]) + "?" + Integer.toString(mLevelHeader.bgSpeed[2]), 118, 170);
                } else if (i == 7) {
                    mGameFont.drawString(g, sel, "Bg Align", 20, 190);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.bgAlign), 118, 190);
                }

                if (i == 8) {
                    mGameFont.drawString(g, sel, "Blocks", 170, 50);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.tileset0), 268, 50);
                }
                if (i == 9) {
                    mGameFont.drawString(g, sel, "Terrain", 170, 70);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.tileset16), 268, 70);
                }
                if (i == 10) {
                    mGameFont.drawString(g, sel, "Scenery", 170, 90);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.tileset32), 268, 90);
                }
                if (i == 11) {
                    mGameFont.drawString(g, sel, "Music", 170, 110);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.music), 268, 110);
                }
                if (i == 12) {
                    mGameFont.drawString(g, sel, "Width", 170, 130);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.width / 16), 268, 130);
                }
                if (i == 13) {
                    mGameFont.drawString(g, sel, "Height", 170, 150);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.height / 16), 268, 150);
                }
                if (i == 14) {
                    mGameFont.drawString(g, sel, "Start X", 170, 170);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.startX), 268, 170);
                }
                if (i == 15) {
                    mGameFont.drawString(g, sel, "Start Y", 170, 190);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.startY), 268, 190);
                }

                if (i == 16) {
                    mGameFont.drawString(g, sel, "End World", 315, 50);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.endWorld), 433, 50);
                }
                if (i == 17) {
                    mGameFont.drawString(g, sel, "End Level", 315, 70);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.endLevel), 433, 70);
                }
                if (i == 18) {
                    mGameFont.drawString(g, sel, "End Area", 315, 90);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.endArea), 433, 90);
                } else if (i == 19) {
                    mGameFont.drawString(g, sel, "Time", 315, 110);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.timeLimit), 433, 110);
                } else if (i == 20) {
                    mGameFont.drawString(g, sel, "End X", 315, 130);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.endX), 433, 130);
                } else if (i == 21) {
                    mGameFont.drawString(g, sel, "End Y", 315, 150);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.endY), 433, 150);
                } else if (i == 22) {
                    mGameFont.drawString(g, sel, "Bonus X", 315, 170);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.bonusX), 433, 170);
                } else if (i == 23) {
                    mGameFont.drawString(g, sel, "Bonus Y", 315, 190);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.bonusY), 433, 190);
                } else if (i == 24) {
                    mGameFont.drawString(g, sel, "Ok", 433, 240);
                }
                mGameFont.drawString(g, sel, "Game Folder", 20, 220);
                mGameFont.drawString(g, sel, SaveFile.mGameName.get(SaveFile.mGameNumber), 20, 240);
            }
            ...
            for (int i = 0; i < 26; i++) {
                ...
                if (i == 0) {
                    ...
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.bgColor.getRed()), 274, 115);
                } else if (i == 1) {
                    mGameFont.drawString(g, sel, "Green", 176, 135);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.bgColor.getGreen()), 274, 135);
                } else if (i == 2) {
                    mGameFont.drawString(g, sel, "Blue", 176, 155);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.bgColor.getBlue()), 274, 155);
                } else if (i == 3) {
            ...
            for (int i = 0; i < 26; i++) {
                ...
                if (i == 0) {
                    ...
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.bgSpeed[0]), 274, 115);
                } else if (i == 1) {
                    mGameFont.drawString(g, sel, "Middle", 176, 135);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.bgSpeed[1]), 274, 135);
                } else if (i == 2) {
                    mGameFont.drawString(g, sel, "Far", 176, 155);
                    mGameFont.drawString(g, sel, Integer.toString(mLevelHeader.bgSpeed[2]), 274, 155);
                } else if (i == 3) {
                    mGameFont.drawString(g, sel, "Ok", 235, 190);
                }
            }
            ...
            mLevelHeader = Main.mFrame.mGamePanel.getHeader();
            ...
            int tmp = Main.mFrame.mGamePanel.getPlayerLives();
            int digit[] = new int[2];
            ...
            if (mTimer > mLevelOpenPause) {
                Main.mFrame.mGamePanel.setMusic(mLevelHeader.music);
            	Settings.State = "game";
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (kc == KeyEvent.VK_ENTER) {
            ...
            if (Settings.State.equals("title")) 
            {
                ...
                {
                    SaveFile.refreshLevelList();
                    Main.mFrame.startEditor();
                    Main.mFrame.mEditorPanel.loadLevel("");
                    Settings.State = "level editor settings";
                    mSelectedOption = 0;
                }
            } else if (Settings.State.equals("level editor create folder")) {
                if (mNewGameName.length() > 0) {
                    String path = "res\\lvl\\" + mNewGameName.trim() + "\\";
                    File f = new File(path);
                    if (f.mkdir()) {
                        SaveFile.mGameName.add(mNewGameName.trim()); 
                        SaveFile.mGameNumber = SaveFile.mGameName.size()-1;
                        SaveFile.refreshLevelList();
                        Main.mFrame.startEditor();
                        Main.mFrame.mEditorPanel.loadLevel("");
                        Settings.State = "level editor settings";
            ...
            } else if (Settings.State.equals("level editor load game")) {
                SaveFile.refreshLevelList();
                if (SaveFile.mLevelName.size() > 0) {
                ...
                Main.mFrame.startEditor();
                String path = "res/lvl/" + SaveFile.mGameName.get(SaveFile.mGameNumber) + "/" + SaveFile.mLevelName.get(mSelectedOption);
                Main.mFrame.mEditorPanel.loadLevel(path + ".lvl");
                mSelectedOption = 0;
            } else if (Settings.State.equals("new")) {
                SaveFile.refreshLevelList();
                if (SaveFile.mLevelName.size() > 0) {
                    Main.mFrame.mGamePanel.newGame();
                    mSelectedOption = 0;
                } 
                ...
                if (mSelectedOption == 0) {
                    ...
                    if (Settings.LevelEditor) {
                        ...
                        Main.mFrame.mEditorPanel.saveLevel("res\\lvl\\" + SaveFile.mGameName.get(SaveFile.mGameNumber) + "\\");
                    } else {
                        Settings.State = "save";
                    }
                    mSelectedOption = 0;
                    ...
                    Main.mFrame.stopEditor();
                    Settings.State = "title";
                    Main.mFrame.mGamePanel.showTitleScreen();
                    Settings.Paused = false;
                    mSelectedOption = 0;
                }
            } else if (Settings.State.equals("save")) {
                Main.mFrame.mGamePanel.saveGame(mSelectedOption);
                Settings.State = "saving";
                mSelectedOption = 0;
            } else if (Settings.State.equals("pause options")) {
                Settings.State = "pause";
        ...
        if (kc == KeyEvent.VK_LEFT || kc == KeyEvent.VK_RIGHT) {
            if (Settings.State.equals("options") || Settings.State.equals("pause options")) {
                ...
                int value;
                if (Settings.State.equals("level editor rgb")) {
                    int minOption;
                    int maxOption;
                    ...
                    Main.mFrame.mEditorPanel.setBackgroundColor(mLevelHeader.bgColor);
                    Main.mFrame.mEditorPanel.setHeader(mLevelHeader);
                }
            } else if (Settings.State.equals("level editor bg speed")) {
                int value;
                if (Settings.State.equals("level editor bg speed")) {
                    int minOption;
                    int maxOption;
                    switch (mSelectedOption)
                    {
                    ...
                    switch (mSelectedOption) {
                        case 0: mLevelHeader.bgSpeed[0] = value; Main.mFrame.mEditorPanel.setBackgroundSpeed(0, value); break;
                        case 1: mLevelHeader.bgSpeed[1] = value; Main.mFrame.mEditorPanel.setBackgroundSpeed(1, value); break;
                        case 2: mLevelHeader.bgSpeed[2] = value; Main.mFrame.mEditorPanel.setBackgroundSpeed(2, value); break;
                        default: value = 0; break;
                    }
            ...
            else if(Settings.State.equals("debug menu"))
            {
                ...
                switch (mSelectedOption)
                {
                    ...
                    case 12: Settings.MainCharacter = value; setCharacter(); Main.mFrame.mGamePanel.createPlayer(); break;
                ...
                switch (mSelectedOption) {
                    ...
                    case 3: value = mLevelHeader.bg[0]; minOption = 0; maxOption = SaveFile.getFileCount("res/bgr/near/") -1; break;
                    case 4: value = mLevelHeader.bg[1]; minOption = 0; maxOption = SaveFile.getFileCount("res/bgr/middle/") -1; break;
                    case 5: value = mLevelHeader.bg[2]; minOption = 0; maxOption = SaveFile.getFileCount("res/bgr/far/") -1; break;
                    ...
                    case 11: value = mLevelHeader.music; minOption = 1; maxOption = SaveFile.getFileCount("res/snd/") - 1; Main.mFrame.mEditorPanel.stopMusic(); break;
                ...
                switch (mSelectedOption) {
                    ...
                    case 3: mLevelHeader.bg[0] = value; Main.mFrame.mEditorPanel.setBackground(mLevelHeader.bg); break;
                    case 4: mLevelHeader.bg[1] = value; Main.mFrame.mEditorPanel.setBackground(mLevelHeader.bg); break;
                    case 5: mLevelHeader.bg[2] = value; Main.mFrame.mEditorPanel.setBackground(mLevelHeader.bg); break;
                    case 6: break; 
                    case 7: mLevelHeader.bgAlign = value; Main.mFrame.mEditorPanel.setBackgroundAlign(value); break;
                    case 8: mLevelHeader.tileset0 = value; Main.mFrame.mEditorPanel.setTileset(mLevelHeader.tileset0, mLevelHeader.tileset16, mLevelHeader.tileset32); break;
                    case 9: mLevelHeader.tileset16 = value; Main.mFrame.mEditorPanel.setTileset(mLevelHeader.tileset0, mLevelHeader.tileset16, mLevelHeader.tileset32); break;
                    case 10: mLevelHeader.tileset32 = value; Main.mFrame.mEditorPanel.setTileset(mLevelHeader.tileset0, mLevelHeader.tileset16, mLevelHeader.tileset32); break;
                    case 11: mLevelHeader.music = value; break;
                    case 12: mLevelHeader.width = value * 16; Main.mFrame.mEditorPanel.setBackgroundWidth(value * 16); break;
                    case 13: mLevelHeader.height = value * 16; Main.mFrame.mEditorPanel.setBackgroundHeight(value * 16); break;
                ...
                Main.mFrame.mEditorPanel.setHeader(mLevelHeader);
                Main.mFrame.mEditorPanel.setMusic(value);
            }
        }
    }
}
