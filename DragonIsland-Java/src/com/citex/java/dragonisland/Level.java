...
public class Level {
    ...
    */
    ...
    public void saveLevel(String path) {
        ...
        try {
            ...
            for (int i = 0; i < mEntities.size(); i++) {
                spr = mEntities.get(i);
                pw.println(spr.tile + "," + spr.x + "," + spr.y);
            }
            pw.close();
        } catch (FileNotFoundException e) {
            e.printStackTrace();
    ...
    */
    ...
    private void initDefinitions() {
        ...
        String line;    
        //tileset 1
        path = System.getProperty("user.dir") + "\\res\\obj\\block\\"
                + mHeader.tileset0 + "\\tileset.ini";       
        try {
            BufferedReader input = new BufferedReader(new FileReader(path));
            try {
        ...
        //tileset 2
        path = System.getProperty("user.dir") + "\\res\\obj\\terrain\\"
                + mHeader.tileset16 + "\\tileset.ini";
        try {
            BufferedReader input = new BufferedReader(new FileReader(path));
            try {
                while ((line = input.readLine()) != null) {
        ...
        //tileset 3
        path = System.getProperty("user.dir") + "\\res\\obj\\scenery\\"
                + mHeader.tileset32 + "\\tileset.ini";
        try {
            BufferedReader input = new BufferedReader(new FileReader(path));
            try {
                while ((line = input.readLine()) != null) {
        ...
        //sprite
        path = System.getProperty("user.dir") + "\\res\\spr\\sprite.ini";
