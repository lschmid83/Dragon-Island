...
public class GLSurfaceViewRenderer implements GLSurfaceView.Renderer {
    ...
    public void onKeyDown(KeyEvent event) {
        ...
        if(Settings.State == "title" && mMain.getTitleScreen() != null)
        	mMain.getTitleScreen().onKeyDown(event.getKeyCode(), true);	
        else if(Settings.State == "level select" && mMain.getLevelSelectScreen() != null)
        	mMain.getLevelSelectScreen().onKeyDown(event.getKeyCode(), true);
        else if(Settings.State == "game" && mMain.getGame() != null)
        	mMain.getGame().onKeyDown(event.getKeyCode(), true);	
    }
    ...
    public void onKeyUp(KeyEvent event) {
    	...
    	if(Settings.State == "title" && mMain.getTitleScreen() != null)
        	mMain.getTitleScreen().onKeyDown(event.getKeyCode(), false);	
    	else if(Settings.State == "game" && mMain.getGame() != null)
        	mMain.getGame().onKeyDown(event.getKeyCode(), false);	
